            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-sm-4 mb-2 d-flex justify-content-center " data-aos-duration="1900" data-aos="fade-right">
                        <a href="<?= base_url('user/kelas4') ?>">
                            <div class="card-kelas text-center">
                                <img src="<?= base_url('assets/') ?>img/kelas4.png" style="object-fit: cover;" class="card-img-top img-fluid" alt="...">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4 mb-2 d-flex justify-content-center " data-aos-duration="1900" data-aos="fade-down">
                        <a href="<?= base_url('user/kelas5') ?>">
                            <div class="card-kelas">
                                <img src="<?= base_url('assets/') ?>img/kelas5.png" class="card-img-top" alt="...">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-left">
                        <a href="<?= base_url('user/kelas6') ?>">
                            <div class="card-kelas">
                                <img src="<?= base_url('assets/') ?>img/kelas6.png" class="card-img-top" alt="...">
                            </div>
                        </a>
                    </div>
                </div>
