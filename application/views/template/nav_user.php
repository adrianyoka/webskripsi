...
<head>
    ...
    <!-- Title -->
    <?php if($page=='index'){ ?>
        <title>Kelas <?php echo $user['tingkat'];echo " ";echo $user['rombel']?> | Student Page</title>
        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="<?= base_url('siswa') ?>"><img src="<?= base_url('assets/') ?>img/logo.png" alt=""></a>
