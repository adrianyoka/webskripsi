...
<section class="section">
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            <p class="card-text">Halaman ini menampilkan data mata pelajaran</p>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
<?php if ($this->session->flashdata('mapel-add')) : ?>
    <script>
        Swal.fire({
            icon: 'success',
            title: '<?=$this->session->flashdata('mapel-add')?>',
            text: 'Data Mata Pelajaran Telah Ditambahkan!',
            showConfirmButton: false,
            timer: 2500
        })
    </script>
<?php unset($_SESSION['mapel-add']);endif; ?>

<?php if ($this->session->flashdata('mapel-delete')) : ?>
    <script>
        Swal.fire({
            icon: 'success',
            title: '<?=$this->session->flashdata('mapel-delete')?>',
            text: 'Data Mata Pelajaran Telah Dihapus!',
            showConfirmButton: false,
            timer: 2500
        })
    </script>
<?php unset($_SESSION['mapel-delete']);endif; ?>

<?php if ($this->session->flashdata('mapel-edit')) : ?>
    <script>
        Swal.fire({
            icon: 'success',
            title: '<?=$this->session->flashdata('mapel-edit')?>',
            text: 'Data Mata Pelajaran Telah Diubah!',
            showConfirmButton: false,
            timer: 2500
        })
    </script>
<?php unset($_SESSION['mapel-edit']);endif; ?>
